...
public class NoteController extends BaseController
{
     ...
     * 查询笔记管理列表
     */
    @PreAuthorize("@ss.hasPermi('im:note:list')")
    @GetMapping("/list")
     ...
     * 导出笔记管理列表
     */
    @PreAuthorize("@ss.hasPermi('im:note:export')")
     ...
     * 获取笔记管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('im:note:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增笔记管理
     */
    @PreAuthorize("@ss.hasPermi('im:note:add')")
     ...
     * 修改笔记管理
     */
    @PreAuthorize("@ss.hasPermi('im:note:edit')")
     ...
     * 删除笔记管理
     */
    @PreAuthorize("@ss.hasPermi('im:note:remove')")
