...
import com.ruoyi.im.domain.Tag;
import com.ruoyi.im.service.ITagService;
...
public class TagController extends BaseController
{
     ...
     * 查询标签管理列表
     */
    @PreAuthorize("@ss.hasPermi('im:tag:list')")
    @GetMapping("/list")
     ...
     * 导出标签管理列表
     */
    @PreAuthorize("@ss.hasPermi('im:tag:export')")
     ...
     * 获取标签管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('im:tag:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增标签管理
     */
    @PreAuthorize("@ss.hasPermi('im:tag:add')")
     ...
     * 修改标签管理
     */
    @PreAuthorize("@ss.hasPermi('im:tag:edit')")
     ...
     * 删除标签管理
     */
    @PreAuthorize("@ss.hasPermi('im:tag:remove')")
