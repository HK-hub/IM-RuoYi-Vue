<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="申请群号" prop="groupId">
        <el-input
      ...
      <el-form-item label="申请说明信息" prop="applyInfo">
        <el-input
      ...
      <el-form-item label="处理回执信息" prop="handleInfo">
        <el-input
          v-model="queryParams.handleInfo"
          placeholder="请输入处理回执信息"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="applyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="申请群号" align="center" prop="groupId" />
      <el-table-column label="处理人id" align="center" prop="handlerId" />
      <el-table-column label="申请类型" align="center" prop="applyType" />
      <el-table-column label="申请说明信息" align="center" prop="applyInfo" />
      <el-table-column label="状态:" align="center" prop="status" />
      <el-table-column label="处理回执信息" align="center" prop="handleInfo" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="申请群号" prop="groupId">
          <el-input v-model="form.groupId" placeholder="请输入申请群号" />
        </el-form-item>
        <el-form-item label="处理人id" prop="handlerId">
          <el-input v-model="form.handlerId" placeholder="请输入处理人id" />
        </el-form-item>
        <el-form-item label="申请说明信息" prop="applyInfo">
          <el-input v-model="form.applyInfo" placeholder="请输入申请说明信息" />
        </el-form-item>
        <el-form-item label="处理回执信息" prop="handleInfo">
          <el-input v-model="form.handleInfo" placeholder="请输入处理回执信息" />
        </el-form-item>
        <el-form-item label="签收状态" prop="sign">
...
<script>
import { listApply, getApply, delApply, addApply, updateApply } from "@/api/im/group_apply";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除群聊申请编号为"' + ids + '"的数据项？').then(function() {
        return delApply(ids);
      }).then(() => {
        this.getList();
